...
## 参加者
“Ninja4名”
コーダー道場経験者3名とプログラミング初体験のNinjaさんが親子参加してくれました。今回は、それぞれ経験や学習進度が異なる4名だったため、各々に適した色々なツールを使い各メンターさんが対応してくれました。

## ツール／やった内容
### Hour of Code
まだPCに不慣れなNinjaさんはMinecraftに挑戦しました。メンターさんや保護者さんと一緒に少しずつ楽しみながら習得している様子でした。また、幼年ですがHour of Codeを自学もしているNinjaさんは低学年用のものに挑戦し自分なりに考えて今まで学んだことを上手に使いながら進めていました。
![](photo_1.jpg)
...
### Minecraft〜コマンド
Minecraftの世界をコードで制御できるコマンドという機能を触りました。
コードでブロックを設置したり、エンティティ(動物、敵、アイテム、プレイヤーなど)を呼出したり、それらの内部データにアクセスしてカスタマイズしたりなどの機能があります。
数値を制御して四則演算を行うことまでできますので、使いこなせばMinecraftの世界をRPGにしたり、ミニゲームを制作したりできます。

![](photo_2.jpg)

今回も参加したNinjaさん全員が作品発表することができました。自分と学習進度の違う他のNinjaさんの作品を見ることもとても良い経験で、みんな興味津々といった様子で見ていました。
