...
## ツール／やった内容
### Hour of Code
初参加の小学1年生のNinjaさんは、CodeMonkyに挑戦。

![](photo_3.jpg)

はじめは戸惑っていましたが、徐々にコードと動きの関係性を理解して自分で色々と試していました。ボタンは英語ですが、イラストもあるのでそれにもすぐ慣れて「STEP！」「Right!」など抵抗なく使っていました。頑張って１５ステージまでいきました。
恥ずかしがりながらも、メンターさんと一緒に発表も行ってくれました。写真からもリラックスして取り組んでいる様子が伺えます。

### Scratch
1年生のNinjaさんは、今回も引き続きScratchに挑戦。CoderDojo柏のチャンピオン、CoderDojoJapan理事でもある宮島衣瑛さんに共有していただいたトレーニングブックを利用して学習を進めていきました。
...
第14回では、工業系modに挑戦していました。採掘場で鉱物を選別して取り出す装置を作り、発表してくれました。
これは、現役高専生メンターの石川さんが、中学生の時にハマっていたModだそうで、条件設定によって情報を制御することを体験できる楽しい学びです。
...
### OSC2018に参加させていただきます。
日程：2018年7月6日(金) 13:00～17:30（セミナーのみ）/ 7月7日(土) 10:00～18:00（展示は16:00まで）
